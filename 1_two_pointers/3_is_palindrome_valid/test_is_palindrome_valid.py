from is_palindrome_valid import is_valid_palindrome, is_valid_palindrome_optimized


def test_empty_string() -> None:
    s = ""
    result = is_valid_palindrome(s)
    result2 = is_valid_palindrome_optimized(s)
    assert result == True and result2 == True
...
def test_non_palindrome_two_chars() -> None:
    ...
    result = is_valid_palindrome(s)
    result2 = is_valid_palindrome_optimized(s)
    assert result == False and result2 == False
